...
function Fan(gl, x, y, z,rotangle,shift) {
...
Fan.prototype.draw = function(gl,  buffers, fieldOfView, aspect, zNear, zFar, programInfo, projectionMatrix,deltaTime,camera,texture) {
    ...
    fanRotation += this.rotation;
		fanRotation = fanRotation % 360;
    ...
    mat4.rotate(modelViewMatrix,  // destination matrix
                ...
                fanRotation * Math.PI / 180,     // amount to rotate in radians
